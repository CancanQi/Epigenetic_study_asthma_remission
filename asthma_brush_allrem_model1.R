...
### this is for all remission in asthma remission project      ###
### we have 4 svs generated by sva                             ###
...
setwd("./sva")
load("./sva_all_remission.Rdata") # read the sva results 
PHENO<-modSv1
...
system.time(ind.res <- mclapply(setNames(seq_len(ncol(beta_matrix)), dimnames(beta_matrix)[[2]]), RLMtest, meth_matrix=beta_matrix, remission=PHENO[,1], X1=PHENO[,2], X2=PHENO[,3], X3=PHENO[,4], X4=PHENO[,5], X5=PHENO[,6],X6=PHENO[,7], S1=PHENO[,8]))
